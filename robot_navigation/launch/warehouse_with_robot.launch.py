...
def generate_launch_description():
    ...
    # This does NOT drive the robot in sim -- it just publishes TF from
    # joint_states so RViz can show the robot model correctly. The actual
    # driving/sensing comes from the model.sdf spawned below.
